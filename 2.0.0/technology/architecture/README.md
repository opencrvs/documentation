...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/RziAMaeBMeyiTg5hfFq5/technology/architecture
---
...
To learn about the server hosting & network architecture required for hosting OpenCRVS visit [this section.](../../../v1.9.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment)
