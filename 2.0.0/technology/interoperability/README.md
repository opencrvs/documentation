...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/RziAMaeBMeyiTg5hfFq5/technology/interoperability
---
...
Performing a [R**ecord search**](../../../v1.9.0/technology/interoperability/create-a-client/record-search-clients.md) of the OpenCRVS database either directly using ur GraphQL Gateway or via a DCI standard middleware.

Submitting an [**"Event Notification"**](../../../v1.9.0/technology/interoperability/create-a-client/event-notification-clients.md) **in FHIR** from healthcare systems

Subscribing to event [**Webhooks**](../../../v1.9.0/technology/interoperability/create-a-client/webhook-clients.md) for status updates on a processing event
