...
Complete customisation is offered in OpenCRVS to designing a smart dynamic declaration form. In the **Country Configuration Files** in the [Release Notes](../../../v1.9.0/general/v1.9-release-notes.md#configuration-template-files) you will find a template file to help you do so. \\
