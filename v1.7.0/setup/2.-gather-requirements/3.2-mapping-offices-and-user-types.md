...
{% hint style="info" %}
Use the User Roles & Scopes Template File found in our [Release Notes](../../general/releases/v1.7-release-notes.md), designed to help you manage and assign appropriate permissions to different user roles in your system.
{% endhint %}
