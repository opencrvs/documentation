...
In the **Country Configuration Files** in the [Release Notes](../../general/releases/v1.7-release-notes.md) you will find a configuration file to help you define your user roles and assign them required scopes. \
