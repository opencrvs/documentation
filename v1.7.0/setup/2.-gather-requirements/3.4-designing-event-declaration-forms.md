...
Complete customisation is offered in OpenCRVS to designing a smart dynamic declaration form. In the **Country Configuration Files** in the [Release Notes](../../general/v1.7-release-notes/) you will find a template file to help you do so. \
