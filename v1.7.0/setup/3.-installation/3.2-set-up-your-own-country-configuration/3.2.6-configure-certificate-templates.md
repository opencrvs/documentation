...
[src/api/certificates/source](https://github.com/opencrvs/opencrvs-farajaland/tree/ocrvs-7584/src/api/certificates/source).
...
1. Open the file [/src/api/certificates/handler.ts](https://github.com/opencrvs/opencrvs-farajaland/blob/ocrvs-7584/src/api/certificates/handler.ts).
...
- **`event`**: The name of the event the certificate is linked to. It must match the [correct event name](https://github.com/opencrvs/opencrvs-farajaland/blob/df0aaa6266ddbe0a2775a263b40f8577f20814eb/src/form/types/types.ts#L43).
- **`label`**:
  - The `id` should match an entry in [src/translations/client.csv](https://github.com/opencrvs/opencrvs-countryconfig/blob/a779fbd30a96c5a2ed08929224ab113c3b865e60/src/translations/client.csv?plain=1#L173).
...
- **`fee`**: Defines fees based on the certificate printing timeframe (`onTime`, `late`, or `delayed`). These terms are defined in the [application-config](https://github.com/opencrvs/opencrvs-countryconfig/blob/a779fbd30a96c5a2ed08929224ab113c3b865e60/src/api/application/application-config.ts#L6).
...
- **`fonts`**:
  ...
  - To use a font:
    - Drop the font files (e.g., regular, bold, italic) in [src/api/fonts](https://github.com/opencrvs/opencrvs-countryconfig/blob/ocrvs-7584/src/api/fonts). **Do not create subfolders.**
