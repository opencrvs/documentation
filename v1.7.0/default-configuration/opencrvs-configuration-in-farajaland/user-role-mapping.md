...
In the **Country Configuration Files** in the [Release Notes](../../general/v1.7-release-notes.md) you will see how we mapped and assigned permissions (scopes) to Farajaland user roles.
