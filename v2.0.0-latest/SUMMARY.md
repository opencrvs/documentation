...
* [Example: Farajaland](implementation/example-farajaland/README.md)
  ...
  * [Configuration](implementation/example-farajaland/configuration/README.md)
    * [Birth form definition](implementation/example-farajaland/configuration/birth-form-definition.md)
    * [Birth record actions - Farajaland](implementation/example-farajaland/configuration/birth-record-actions-farajaland.md)
* [Your OpenCRVS](implementation/your-opencrvs/README.md)
  ...
  * [Gathering requirements](implementation/your-opencrvs/gathering-requirements/README.md)
    * [Desk research & planning](implementation/your-opencrvs/gathering-requirements/preparation-and-foundation.md)
    ...
    * [Design & specification](implementation/your-opencrvs/gathering-requirements/design-and-specification/README.md)
      * [Guides](implementation/your-opencrvs/gathering-requirements/design-and-specification/guides/README.md)
        * [Guide: Event configuration](implementation/your-opencrvs/gathering-requirements/design-and-specification/guides/guide-event-configuration/README.md)
          * [Name change](implementation/your-opencrvs/gathering-requirements/design-and-specification/guides/guide-event-configuration/name-change.md)
        * [Guide: Form configuration](implementation/your-opencrvs/gathering-requirements/design-and-specification/guides/guide-form-configuration.md)
        * [Guide: Certificate configuration](implementation/your-opencrvs/gathering-requirements/design-and-specification/guides/guide-certificate-configuration.md)
        * [Guide: Mapping offices and users](implementation/your-opencrvs/gathering-requirements/design-and-specification/guides/guide-mapping-offices-and-users.md)
  * [Solution architecture](implementation/your-opencrvs/solution-architecture.md)
  * [Configuration](implementation/your-opencrvs/configuration.md)
...
* [Guides](technical/guides/README.md)
  ...
  * [Configuration](technical/guides/configuration/README.md)
    ...
    * [Administrative hierarchy](technical/guides/configuration/locations/README.md)
      * [Administrative areas](technical/guides/configuration/locations/administrative-structure.md)
      * [Locations](technical/guides/configuration/locations/facilities.md)
      * [How to populate administrative hierarchy](technical/guides/configuration/locations/how-to-populate-administrative-hierarchy.md)
      * [How to configure place of event](technical/guides/configuration/locations/how-to-configure-place-of-event.md)
      * [How to limit location and administrative area options in event declaration](technical/guides/configuration/locations/how-to-limit-location-and-administrative-area-options-in-event-declaration.md)
    * [Users](technical/guides/configuration/users/README.md)
      * [Roles and scopes](technical/guides/configuration/users/jurisidictions.md)
      * [How to configure scopes](technical/guides/configuration/users/how-to-configure-scopes.md)
      * [How "user scope" options map to user details?](technical/guides/configuration/users/roles.md)
  ...
  * [Integration](technical/guides/integration/README.md)
    ...
    * [MOSIP Overview](technical/guides/integration/mosip-overview.md)
