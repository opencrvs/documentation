...
Please check [4.2.10 Build Country config docker image](../../../../../../v2.0.0/setup/3.-installation/3.2-set-up-your-own-country-configuration/4.2.10-build-country-config-docker-image.md) for more information.
