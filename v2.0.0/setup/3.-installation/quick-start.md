...
* Run fully functional local development environment, see [here](../../../v2.0.0/setup/3.-installation/3.1-set-up-a-development-environment/)
* Install OpenCRVS on the server, see [3.3-set-up-a-server-hosted-environment](../../../v2.0.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment/ "mention")
* Read more about advanced configurations options available here and for [Dependencies helm chart](../../../v2.0.0/setup/3.-installation/dependencies/)
