...
1. The first thing that you want to do is to change the name of the cloned opencrvs-countryconfig directory to something like "opencrvs-\<your country>".
...
5.  In Terminal, `cd` inside your local directory for the country configuration, opencrvs-\<your country>. If you run `git remote -v` inside this directory you should see that the origin Git URLs are still pointing to our Country config repo. We need to point these origin URLs to your repo. To do that, run this command:
...
<figure><img src="../../../../v1.7.0/.gitbook/assets/Screenshot 2024-11-11 at 15.56.57.png" alt=""><figcaption></figcaption></figure>
