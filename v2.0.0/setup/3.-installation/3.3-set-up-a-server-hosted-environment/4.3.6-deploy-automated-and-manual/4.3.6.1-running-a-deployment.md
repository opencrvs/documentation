...
You can deploy to your server using the automated **"Deploy OpenCRVS"** Github Action for any environment create at [Create a GitHub Environment](../4.3.4-create-a-github-environment/README.md) step

First, use Deploy (development) to deploy to a relevant environment to test the process.

<figure><img src="../../../../../v1.7.0/.gitbook/assets/Screenshot 2024-02-13 at 17.08.06.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../../../v1.7.0/.gitbook/assets/Screenshot 2024-02-13 at 17.25.09.png" alt=""><figcaption></figcaption></figure>
