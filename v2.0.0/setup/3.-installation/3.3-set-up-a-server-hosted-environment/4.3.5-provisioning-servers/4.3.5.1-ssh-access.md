...
{% hint style="info" %}
`yarn environment:init` script automatically handles this configuration you, check [4.3.1-create-a-github-environment](../4.3.1-create-a-github-environment/ "mention")
{% endhint %}
