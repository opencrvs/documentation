...
6.  Connect to staging cluster with `kubectl` :
    ...
    ```
7.  Change namespace to opencrvs-deps-\<environment>, where `<environment>` is stagig environment name:
...
Push your changes to github and Re-[Deploy OpenCRVS](../4.3.6-deploy/4.3.6.1-running-a-deployment-1.md)
