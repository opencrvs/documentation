# 4.3.4.1 LetsEncrypt https challenge in development environments
...
{% hint style="info" %}
Before you begin please make sure github environment was created using `yarn environment:init` script, check Create a github environment
{% endhint %}
