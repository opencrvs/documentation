...
{% hint style="warning" %}
This guide does not cover prerequisites installation steps. OpenCRVS team has limited capacity to test different configurations. Feel free to submit an issue on GitHub if something doesn't work in your hardware or software setup.
{% endhint %}
...
Following dependencies are required only if you are not OpenCRVS core contributor:
...
### Configure Docker engine and Kubernetes cluster
