...
{% content-ref url="../../../v1.9.0/setup/3.-installation/3.1-set-up-a-development-environment" %}
[3.1-set-up-a-development-environment](../../../v1.9.0/setup/3.-installation/3.1-set-up-a-development-environment)
{% endcontent-ref %}

{% content-ref url="../../../v1.9.0/setup/3.-installation/3.2-set-up-your-own-country-configuration" %}
[3.2-set-up-your-own-country-configuration](../../../v1.9.0/setup/3.-installation/3.2-set-up-your-own-country-configuration)
{% endcontent-ref %}

{% content-ref url="../../../v1.9.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment" %}
[3.3-set-up-a-server-hosted-environment](../../../v1.9.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment)
{% endcontent-ref %}
