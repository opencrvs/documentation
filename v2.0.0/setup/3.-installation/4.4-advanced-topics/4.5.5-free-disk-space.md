...
* /data/elasticsearch, see [#elasticsearch-disk-cleanup](4.5.5-free-disk-space.md#elasticsearch-disk-cleanup "mention")
* /data/postgres, see [#postgresql-storage](4.5.5-free-disk-space.md#postgresql-storage "mention")
* /data/minio, see [#minio-storage-cleanup](4.5.5-free-disk-space.md#minio-storage-cleanup "mention")
...
* Increase `/data` partition size, see [#increase-data-partition](4.5.5-free-disk-space.md#increase-data-partition "mention")
