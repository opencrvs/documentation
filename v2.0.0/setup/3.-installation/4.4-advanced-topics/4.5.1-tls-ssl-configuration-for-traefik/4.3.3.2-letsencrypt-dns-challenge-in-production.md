...
{% hint style="info" %}
Before you begin please make sure github environment was created using `yarn environment:init` script, check [4.3.1-create-a-github-environment](../../3.3-set-up-a-server-hosted-environment/4.3.1-create-a-github-environment/ "mention")
{% endhint %}
