...
**The configuration inputs** you produce, and the guide that supports each.  Example configuration inputs that we produce for Farajaland exist in our [**release notes**](../../../../releases/release-notes.md).:
