...
* [4. Installation](setup/3.-installation/README.md)
  ...
  * [4.2 Set-up your own, local, country configuration](setup/3.-installation/3.2-set-up-your-own-country-configuration/README.md)
    * [FIXME: 4.2.1 Fork your own country configuration repository](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.1-fork-your-own-country-configuration-repository.md)
  ...
  * [4.3 Set-up a server-hosted environment](setup/3.-installation/3.3-set-up-a-server-hosted-environment/README.md)
    ...
    * [4.3.4 TLS / SSL & DNS](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.3-tls-ssl-and-dns/README.md)
      ...
      * [4.3.4.3 Static TLS certificates](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.3-tls-ssl-and-dns/4.3.3.3-static-tls-certificates.md)
    * [4.3.5 Deploy](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.6-deploy/README.md)
      * [4.3.5.1 Building, pushing & releasing your countryconfig code](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.6-deploy/4.3.5.3-building-pushing-and-releasing-your-countryconfig-code.md)
      * [4.3.5.2 Running Dependencies deployment](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.6-deploy/4.3.6.1-running-a-deployment.md)
      * [4.3.5.3 Running an OpenCRVS deployment](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.6-deploy/4.3.6.1-running-a-deployment-1.md)
      * [4.3.5.4 Login to an OpenCRVS server](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.6-deploy/4.3.6.3-login-to-an-opencrvs-server.md)
    * [4.3.6 Maintenance](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.6-maintenance/README.md)
      ...
      * [4.3.7 Backup & Restore](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.6-maintenance/4.3.7-backup-and-restore/README.md)
        * [4.3.7.1 Automated backup configuration](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.6-maintenance/4.3.7-backup-and-restore/4.3.7.1-automated-backup-configuration.md)
        * [4.3.7.2 Manual backup creation](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.6-maintenance/4.3.7-backup-and-restore/4.3.7.2-manual-backup-creation.md)
        * [4.3.7.3 Automated restore configuration](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.6-maintenance/4.3.7-backup-and-restore/4.3.7.1-restoring-a-backup.md)
        * [4.3.7.4 Manual restore / Disaster recovery](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.6-maintenance/4.3.7-backup-and-restore/4.3.7.4-manual-restore-disaster-recovery.md)
        * [4.3.7.5 Off-boarding from OpenCRVS](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.6-maintenance/4.3.7-backup-and-restore/4.3.7.2-off-boarding-from-opencrvs.md)
  * [4.4 Advanced topics](setup/3.-installation/4.4-advanced-topics.md)
