...
* [4. Installation](setup/3.-installation/README.md)
  ...
  * [4.3 Set-up a server-hosted environment](setup/3.-installation/3.3-set-up-a-server-hosted-environment/README.md)
    ...
    * [4.3.2 Create a Github environment](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.1-create-a-github-environment/README.md)
      ...
      * [4.3.2.2 TLS/SSL Configuration for traefik](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.1-create-a-github-environment/4.3.2.2-tls-ssl-configuration-for-traefik/README.md)
        * [4.3.2.2 LetsEncrypt https challenge in development environments](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.1-create-a-github-environment/4.3.2.2-tls-ssl-configuration-for-traefik/4.3.3.1-letsencrypt-https-challenge-in-development-environments.md)
        * [4.3.2.3 LetsEncrypt DNS challenge in production](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.1-create-a-github-environment/4.3.2.2-tls-ssl-configuration-for-traefik/4.3.3.2-letsencrypt-dns-challenge-in-production.md)
        * [4.3.2.4 Static TLS certificates](setup/3.-installation/3.3-set-up-a-server-hosted-environment/4.3.1-create-a-github-environment/4.3.2.2-tls-ssl-configuration-for-traefik/4.3.3.3-static-tls-certificates.md)
  ...
  * [4.4 OpenCRVS maintenance tasks](setup/3.-installation/4.4-opencrvs-maintenance-tasks/README.md)
    * [4.3.6.3 Seeding a server environment](setup/3.-installation/4.4-opencrvs-maintenance-tasks/4.3.6.2-seeding-a-server-environment.md)
    * [4.3.6.5 Resetting a server environment](setup/3.-installation/4.4-opencrvs-maintenance-tasks/4.3.6.5-resetting-a-server-environment.md)
    * [4.3.7 Backup & Restore](setup/3.-installation/4.4-opencrvs-maintenance-tasks/4.3.7-backup-and-restore/README.md)
      * [4.3.7.1 Automated backup configuration](setup/3.-installation/4.4-opencrvs-maintenance-tasks/4.3.7-backup-and-restore/4.3.7.1-automated-backup-configuration.md)
      * [4.3.7.2 Manual backup creation](setup/3.-installation/4.4-opencrvs-maintenance-tasks/4.3.7-backup-and-restore/4.3.7.2-manual-backup-creation.md)
      * [4.3.7.3 Automated restore configuration](setup/3.-installation/4.4-opencrvs-maintenance-tasks/4.3.7-backup-and-restore/4.3.7.1-restoring-a-backup.md)
      * [4.3.7.4 Manual restore / Disaster recovery](setup/3.-installation/4.4-opencrvs-maintenance-tasks/4.3.7-backup-and-restore/4.3.7.4-manual-restore-disaster-recovery.md)
      * [4.3.7.5 Off-boarding from OpenCRVS](setup/3.-installation/4.4-opencrvs-maintenance-tasks/4.3.7-backup-and-restore/4.3.7.2-off-boarding-from-opencrvs.md)
  * [4.5 Advanced topics](setup/3.-installation/4.4-advanced-topics/README.md)
    * [Add Custom GitHub secrets to Kubernetes](setup/3.-installation/4.4-advanced-topics/add-custom-github-secrets-to-kubernetes.md)
    * [Migration from Docker swarm guide](setup/3.-installation/4.4-advanced-topics/migration-from-docker-swarm-guide.md)
