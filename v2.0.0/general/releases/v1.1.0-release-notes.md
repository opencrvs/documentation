...
[Simpler command to start country configuration server](../../setup/3.-installation/3.1-set-up-a-development-environment/3.1.3-local-environment-maintenance.md)
