...
The demonstration used hardcoded CRVS\_OFFICE and HEALTH\_FACILITY ids.  These can be dynamically retrieved via the OpenCRVS [Location](https://app.gitbook.com/s/TIJguU5Pzi7HeHrkXa4I/technical/apis/core-apis/locations) API.
