...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/RziAMaeBMeyiTg5hfFq5/
---
...
* to run OpenCRVS on your laptop, take a look at the [Quick Start](../v1.9.0/setup/3.-installation/3.1-set-up-a-development-environment).
* to technically configure OpenCRVS, go to [Configure](../v1.9.0/setup/3.-installation/3.2-set-up-your-own-country-configuration).
* to deploy to a server, a configured version of OpenCRVS, go to [Deploy](../v1.9.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment).
