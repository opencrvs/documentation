...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/RziAMaeBMeyiTg5hfFq5/default-configuration/opencrvs-configuration-in-farajaland/certificate-templates
---
...
In the **Country Configuration Files** in the [Release Notes](../../../v1.9.0/general/v1.8-release-notes) you will find the svgs created for Farajaland certified copies
