...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/RziAMaeBMeyiTg5hfFq5/default-configuration/opencrvs-configuration-in-farajaland/user-role-mapping
---
...
In the **Country Configuration Files** in the [Release Notes](../../../v1.9.0/general/v1.9-release-notes) you will see how we mapped and assigned permissions (scopes) to Farajaland user roles.
