...
{% hint style="info" %}
See our guide on how to design and configure a certificate [guide-certificate-configuration.md](../../../implementation/your-opencrvs-project/gathering-requirements/design-and-specification/guides/guide-certificate-configuration.md "mention")
{% endhint %}
