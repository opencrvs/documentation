---
description: >-
  OpenCRVS 1.6.1 is a hotfix release that adds minor improvements and bug fixes to the product based on the identified needs of countries using OpenCRVS.
---
