...
{% hint style="info" %}
Its recommended to configure connection to cluster as described at [Add new cluster to your default kubeconfig](../../3.3-set-up-a-server-hosted-environment/4.3.5-provisioning-servers/4.3.5.2-kubernetes-cluster-access.md#option-3-add-new-cluster-to-your-default-kubeconfig) before running this task.
{% endhint %}
...
Push your changes to github and Re-[Deploy Dependencies](../../3.3-set-up-a-server-hosted-environment/4.3.6-deploy/4.3.6.1-running-a-deployment.md)
...
Push your changes to github and Re-[Deploy OpenCRVS](../../3.3-set-up-a-server-hosted-environment/4.3.6-deploy/4.3.6.1-running-a-deployment-1.md)
