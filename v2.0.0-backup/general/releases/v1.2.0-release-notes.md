...
New subdomains required for Minio in [DNS](../../../v1.8.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.5-setup-dns-a-records) settings
...
Clearer instructions for [deploying](../../../v1.8.0/setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual) either automated or manual with Minio secrets added
...
**Introducing** [**Minio**](https://min.io/) **in OpenCRVS: An AWS S3 compatible OpenSource and locally hosted** [**Object Store**](https://en.wikipedia.org/wiki/Object_storage)
