...
All event-related notifications pass through the [**`onAnyActionHandler`**](https://github.com/opencrvs/opencrvs-core/blob/v2.1.0-beta/packages/countryconfig-template/src/index.ts) endpoint in _countryconfig_.\
This handler is triggered whenever an event changes status (e.g., **VALIDATED → REGISTERED**).

From this handler (or other related Action trigger), configurable logic can route into a shared [**`notify`**](https://github.com/opencrvs/opencrvs-core/blob/v2.1.0-beta/packages/countryconfig-template/src/api/notification/handler.ts) method where you can:
...
This is an optional place to configure message behaviour for your country implementation.  But of course you can refactor to suit your needs in your countryconfig fork.
...
* Templates are located in the email [templates](https://github.com/opencrvs/opencrvs-core/tree/v2.1.0-beta/packages/countryconfig-template/src/api/notification/email-templates) directory
...
* Templates are stored in the SMS templates [directory](https://github.com/opencrvs/opencrvs-core/blob/v2.1.0-beta/packages/countryconfig-template/src/translations/notification.csv)
...
All notifications related to staff pass through [these](https://github.com/opencrvs/opencrvs-core/blob/v2.1.0-beta/packages/countryconfig-template/src/config/routes/userNotificationRoutes.ts) routes and should only be carefully modified. Usually these will use Email by default.  Normally it is not necessary to make any changes here.
