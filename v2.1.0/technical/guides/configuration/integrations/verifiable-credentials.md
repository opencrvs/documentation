...
[issue-birth-credential-action.ts](https://github.com/opencrvs/opencrvs-core/blob/v2.1.0-beta/packages/testland/src/verifiable-credentials/issue-birth-credential-action.ts)
...
[birth-credential-template.ts](https://github.com/opencrvs/opencrvs-core/blob/v2.1.0-beta/packages/testland/src/verifiable-credentials/birth-credential-template.ts)
...
[print-birth-credential-action.ts](https://github.com/opencrvs/opencrvs-core/blob/v2.1.0-beta/packages/testland/src/verifiable-credentials/print-birth-credential-action.ts)
...
[paper-birth-credential-template.ts](https://github.com/opencrvs/opencrvs-core/blob/v2.1.0-beta/packages/testland/src/verifiable-credentials/paper-birth-credential-template.ts)
...
All files referenced above live in the [reference country configuration](https://github.com/opencrvs/opencrvs-core/tree/v2.1.0-beta/packages/testland/src/verifiable-credentials) (`packages/testland`). Use them as a starting point for your own implementation:
