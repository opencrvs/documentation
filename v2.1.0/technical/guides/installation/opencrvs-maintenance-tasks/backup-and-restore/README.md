...
{% hint style="info" %}
Backup and restore is automatically configured while environment creation by `yarn environment:init` script, check [Create a Github environment](../../deploy-set-up-a-server-hosted-environment/create-a-github-environment/). This guide dives into details:
