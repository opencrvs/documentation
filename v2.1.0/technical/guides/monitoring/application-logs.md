...
<figure><img src="../../../.gitbook/assets/image (32).png" alt=""><figcaption><p>All incoming requests go through Traefik ingress controller, almost always it will be on the top of the list. On the screenshot all transactions that took longer then 1 second (1000000us) are shown.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (33).png" alt=""><figcaption><p>Transaction information is useful to identify particular service latency</p></figcaption></figure>
