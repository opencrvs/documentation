...
| user.create                              | <p>This scope allows a user to create a new user<br>:all  - any user<br>:my-jurisdiction - only users in the users jurisdiction</p>                                                                                                                              |
| user.edit                                | <p>This scope defines what user roles you can edit<br>- role - role typers the user can create and edit<br>- :all  - any user<br>- :my-jurisdiction - only users in the users jurisdiction</p>                                                                   |
