...
{% hint style="info" %}
[Configuration, testing and technical configuration files](../../general/release-notes.md) Check out our release notes for configuration template files to help you configure your OpenCRVS instance and version
{% endhint %}
