...
In the **Country Configuration Files** in the [Release Notes](../../general/v1.9-release-notes/) you will see how we mapped and assigned permissions (scopes) to Farajaland user roles.
