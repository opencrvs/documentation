# Swarm Server crashed re-mount disk
...
3. Mount it back `sudo /opt/opencrvs/infrastructure/cryptfs/mount.sh --mount /data --file /cryptfs_file_sparse.img -p <ENCRYPTION KEY>`
