...
These secrets and variables are entirely dependant on the [prerequisite accounts and repositories](create-prerequisite-accounts-and-repositories.md).

#### Further reading

The [Advanced topics](../../advanced-topics/) section gives you important detail on the various configurations related to servers, TLS, SSH access (to comply with internal procedures), Kubernetes cluster management and disk space.
