...
From this handler (or other related Action trigger), configurable logic can route into a shared [**`notify`**](https://github.com/opencrvs/opencrvs-countryconfig/blob/0fc50a9d21d2c7525e5b8e3b8f1cd7c0ca7a7328/src/api/notification/handler.ts#L143) method where you can:
...
All notifications related to staff pass through [these](https://github.com/opencrvs/opencrvs-countryconfig/blob/develop/src/config/routes/userNotificationRoutes.ts) routes and should only be carefully modified. Usually these will use Email by default.  Normally it is not necessary to make any changes here.
