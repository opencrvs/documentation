...
Check out the [Configuration, testing and technical configuration files](https://github.com/opencrvs/documentation/blob/master/v1.9.0/general/releases/README.md) for detailed guidance on configuration and version-specific documentation.
