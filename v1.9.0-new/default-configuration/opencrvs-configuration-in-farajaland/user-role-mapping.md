...
In the **Country Configuration Files** in the [Release Notes](../../../v1.8.0/general/v1.8-release-notes) you will see how we mapped and assigned permissions (scopes) to Farajaland user roles.
