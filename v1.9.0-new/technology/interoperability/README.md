...
Integrating with an external [National ID ](national-id-client/)system is a complex topic with multiple, optional use cases available.  A dedicated section on National ID integration exists to cover:
