...
* Added a local virtual machine setup for testing Ansible playbooks locally (on MacOS and Ubuntu ). Check [provision.ipynb](../../v1.8.0/general/v1.8-release-notes/infrastructure/local-development/provision.ipynb) for more details.
